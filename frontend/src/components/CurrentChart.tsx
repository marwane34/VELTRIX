...
export default function CurrentChart({ data, height = 160 }: ChartProps) {
  ...
  return (
    <svg width="100%" height={h} viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="none" style={{ display: 'block' }}>
      <text x="10" y="14" fill="var(--text-muted)" fontSize="10" fontFamily="sans-serif">Current (A)</text>
      ...
      <polyline points={pts} fill="none" stroke="var(--accent-yellow)" strokeWidth="1.5" />
    </svg>
  );
}
