/*
# VELTRIX Predictive Maintenance — Full Schema with Reports

Creates all tables for the VELTRIX SCADA dashboard including the new reports table:
- machines: Monitored machines with vibration/temp/current thresholds
- sensors: Sensors attached to machines
- sensor_data: Time-series readings from sensors
- sensor_snapshots: Aggregated machine health snapshots
- machine_health: Latest health state per machine
- alerts: Anomaly alerts
- settings: General key-value settings per user
- communication_settings: Industrial protocol configs (6 protocols)
- reports: Exported report metadata for the Export Center (NEW)
